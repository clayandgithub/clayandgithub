---
layout:     post
title:      "[笔记]基于theano实现gpu版的神经网络算法"
subtitle:   "First program on gpu"
date:       2016-09-21
author:     "王维维"
...
忙了一阵子，继续神经网络的学习。这次按照[speeding-up-your-neural-network-with-theano-and-the-gpu](http://www.wildml.com/2015/09/speeding-up-your-neural-network-with-theano-and-the-gpu/)教程完成了[theano版的神经网络](https://github.com/clayandgithub/nn-theano)，并用gpu进行加速。
...
更多代码参考[github](https://github.com/clayandgithub/nn-theano)
...
[1]: /img/nn_theano_gpu_classification.png